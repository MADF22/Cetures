...
export default function MarketingPage() {
  return (
    <div className="relative flex flex-col items-center dark:bg-[#1F1F1F] min-h-screen overflow-hidden">
      ...
      <main className="flex flex-col items-center text-center w-full max-w-6xl mx-auto px-4 relative">
        <div className="flex flex-col items-center gap-y-12 md:gap-y-20 w-full py-20 md:py-28">
          <Heading />
          <Heroes />
        </div>
      </main>
